...
class Test(TestCase):
    ...
    def test_get_containing_app_data_succeed(self):
        self.assertEqual(compat.get_containing_app_data(
            'django.contrib.admin.views'), ('admin', 'django.contrib.admin'))
        self.assertEqual(compat.get_containing_app_data(
            'django.contrib.auth.urls'), ('auth', 'django.contrib.auth'))
