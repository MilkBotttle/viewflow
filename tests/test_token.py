...
class Test(TestCase):
    ...
    def test_token_api(self):
        ...
        self.assertEqual(
            token.get_common_split_prefix(
                'start/1_2', 0), 'start/1_2/3_')
    ...
    def test_split_token_source_generator(self):
        ...
        self.assertEqual(set([token.get_common_split_prefix(
            'start/1_2/3_4', 0) for token in tokens]), set(['start/1_2/3_4/5_']))
